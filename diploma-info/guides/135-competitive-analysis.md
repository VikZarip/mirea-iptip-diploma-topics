...
```markdown
**Методика тестирования Аналога 1:**
...
1. **Аналог 1** (https://example1.com) — коммерческая система мониторинга 
   качества воздуха с функциями визуализации.
   
2. **Аналог 2** (https://github.com/user/project) — open-source решение 
   на базе Node.js для IoT-мониторинга.
   
3. **Аналог 3** — система из исследования [1], реализующая прогноз 
   загрязнения воздуха с использованием LSTM.

Выбор обусловлен тем, что данные системы решают схожие задачи и 
представляют разные технологические подходы.
